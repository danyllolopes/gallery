...
import DialogContent, { Dialog, DialogBody, DialogClose, DialogFooter, DialogHeader, DialogTrigger } from "../../../components/dialog";
            ...
            <form onSubmit={form.handleSubmit(handleSubmit)}>
                ...
                <DialogBody className="flex flex-col gap-5">
                    ...
                    <div className="space-y-3">
                        <Text as="p" variant="label-small" className="mb-3">Fotos cadastradas</Text>
