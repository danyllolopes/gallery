...
export function DialogHeader({ children, className, ...props }: React.ComponentProps<'header'>) {
    return (
        <>
...
export default function DialogContent({ className, ref, children, ...props }: React.ComponentProps<typeof DialogPrimitive.Content>) {
    return (
